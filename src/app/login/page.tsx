    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 mt-2">Automate your business processes</p>
        </div>
          ...
          <Tabs defaultValue="login" className="w-full">
            ...
            <TabsContent value="register">
              <CardHeader>
                ...
                <p className="text-gray-600 text-center">Get started with Workflow Studio</p>
              </CardHeader>
              <CardContent>
                ...
                <div className="mt-6 text-center text-sm text-gray-600">
                  ...
                  <button
                    onClick={() => {
                      const tabsList = document.querySelector('[value="login"]') as HTMLElement
                      tabsList?.click()
                    }}
