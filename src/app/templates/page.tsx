...
export default function TemplatesPage() {
  ...
  const stats = {
    ...
    usedTemplates: templates.filter(t => t.isUsed).length,
      ...
      <div className="p-6 grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <Card>
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-600">Used Templates</p>
                <p className="text-2xl font-bold text-gray-900">{stats.usedTemplates}</p>
              </div>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-gray-900">{stats.avgUsage}</p>
              </div>
          ...
          <div className="flex gap-2">
            ...
            <div className="flex gap-2">
              {categories.map(category => (
                ...
                >
                  {category === 'all' ? 'All' : category} ({category === 'all' ? templates.length : templates.filter(t => t.category === category).length})
                </Button>
              ))}
            </div>
          </div>
