  ...
  const features = [
    {
      ...
      description: 'Drag-and-drop email builder with react-email-editor for professional templates',
      color: 'text-blue-600'
    },
    {
      icon: Sparkles,
      ...
      <header className="bg-white border-b border-gray-200 px-6 py-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900">Email Builder Pro</h1>
              <p className="text-sm text-gray-500">Professional email template builder</p>
            </div>
          </div>
          
          <div className="flex items-center gap-3">
            <Badge variant="secondary">Powered by React Email Editor</Badge>
            <Link href="/templates">
              <Button>
                View Templates
      ...
      <div className="container mx-auto px-6 py-12">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            Create stunning email templates with our powerful drag-and-drop editor powered by react-email-editor. 
            Design, preview, and export professional emails in minutes.
          </p>
        ...
        <div className="mb-16">
          <div className="flex items-center justify-between mb-8">
            <h3 className="text-3xl font-bold text-gray-900">Recent Templates</h3>
            <Link href="/templates">
        ...
        <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-12 text-center text-white">
          <h3 className="text-3xl font-bold mb-4">Ready to create amazing emails?</h3>
          <p className="text-xl mb-8 opacity-90">
            Join thousands of users who are already creating professional email templates with our builder.
          </p>
